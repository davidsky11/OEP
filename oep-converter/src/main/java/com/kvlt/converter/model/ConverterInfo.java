package com.kvlt.converter.model;

import com.kvlt.converter.enums.ConverterStatusEnum;
import com.kvlt.converter.enums.ConverterTypeEnum;
import com.kvlt.model.BaseModel;
...
public class ConverterInfo extends BaseModel {
	...
	/**
	 * @param converterType the converterType to set
	 */
	...
	/**
	 * @param converterTime the converterTime to set
	 */
