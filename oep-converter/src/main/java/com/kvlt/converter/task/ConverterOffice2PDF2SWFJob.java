 ...
 */
package com.kvlt.converter.task;

import com.kvlt.converter.config.ConverterConfiguration;
import com.kvlt.converter.enums.ConverterExecutorEnum;
import com.kvlt.converter.enums.ConverterStatusEnum;
import com.kvlt.converter.executor.CaptureImageConverterExecutor;
import com.kvlt.converter.executor.ConverterExecutor;
import com.kvlt.converter.executor.WatermarkConverterExecutor;
import com.kvlt.converter.locator.ConverterLocator;
import com.kvlt.converter.model.ConverterInfo;
import com.kvlt.converter.utils.FileConverterUtils;
...
public class ConverterOffice2PDF2SWFJob {
	...
	public void doConvert() {
		...
		List<ConverterInfo> convertInfos = new ArrayList<>();
