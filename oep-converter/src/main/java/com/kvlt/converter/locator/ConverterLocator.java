 ...
 */
package com.kvlt.converter.locator;
...
import com.kvlt.converter.executor.OpenofficeConverterExecutor;
import com.kvlt.converter.executor.SwftoolsConverterExecutor;
...
public class ConverterLocator extends AbstractConverterLocator {
	...
	public ConverterExecutor createConverterExecutor(ConverterExecutorEnum executorEnum) {
		...
		if (ConverterExecutorEnum.OPENOFFICE_EXECUTOR.equals(executorEnum)) {
			...
			throw new ConverterException("Illegal The facade paramter executor error : " + executorEnum + " is not support.");
		}
