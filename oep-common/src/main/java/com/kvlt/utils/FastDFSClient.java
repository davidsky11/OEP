...
public class FastDFSClient {
	...
	private final static Logger logger = Logger.getLogger(FastDFSClient.class);
	...
	static {
		try {
			CONF_FILENAME = URLDecoder.decode(Thread.currentThread().getContextClassLoader().getResource("").getPath()
					+ "fdfs/fdfs_client.conf", "utf-8");
	...
	public static void main(String[] args) {
		//		String filePath = "D:/QQ图片20160325103809.png";
		//		File file = new File(filePath);
		//		String fileId = uploadFile(file, filePath);
		//		System.out.println(fileId);

		//		String mediaFilePath = "group1/M00/00/00/wKg4Q1cwSvGAYG8bACzn8EuiWX4880.mp4";
