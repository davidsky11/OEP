...
public class SQLGenerator<T> {
    ...
    public SQLGenerator(Set<String> columns, String tableName, String pkName, String seq) {
        super();
    ...
    public String sql_createOfBatch(List<T> tList,
        ...
        if(StringUtil.isNotEmpty(seq) && null == pkVal){
            // ID使用序列
            sql_build.append("INSERT INTO ").append(tableName).append("(")
            ...
            for (; i < len; i++) {
                ...
                sql_build.append(StringUtil.join(values, ",")).append(
                        " FROM DUAL ");
            }
        }
    ...
    private List<Object> obtainFieldValues(T t,
        ...
        for (String column : columns) {
            Object value = ReflectUtil.obtainFieldValue(t, currentColumnFieldNames.get(column));
    ...
    private Object handleValue(Object value) {
        if (value instanceof String) {
            ...
            String dateStr = DateUtil.getFullFormatTime(date);
    ...
    public String sql_modify(T t, Map<String, String> currentColumnFieldNames) {
        ...
        Object id = ReflectUtil.obtainFieldValue(t,
     ...
     * @return
     */
    private List<String> obtainColumnVals(T t, Map<String, String> currentColumnFieldNames) {
        List<String> colVals = new LinkedList<String>();
        for (String column : columns) {
            Object value = ReflectUtil.obtainFieldValue(t,
