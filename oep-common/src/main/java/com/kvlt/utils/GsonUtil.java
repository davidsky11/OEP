...
public class GsonUtil {
    ...
    public static boolean isJsonObject(String text) {
        final JsonElement jsonElement = json2Element(text);
        if (jsonElement == null)
            return false;
    ...
    public static JsonElement json2Element(String json) {
        try {
    ...
    public static boolean isJson(String text) {
        if (text == null)
            ...
            return false;
        else if ("null".equalsIgnoreCase(text.trim()))
            return false;
        try {
            final JsonElement jsonElement = json2Element(text);
            if (jsonElement == null)
    ...
    public static String getElementType(JsonElement jsonElement) {
        try {
    ...
    public static List<String> keys(String json) {
        final JsonElement jsonElement = json2Element(json);
        if (jsonElement == null)
            return null;
        ...
        if (jsonElement.isJsonObject()) {
            ...
            final Iterator<Map.Entry<String, JsonElement>> it = set.iterator();
