...
public enum EnumErrorCode {
    ...
    EnumErrorCode(Number code, String des) {
        this.code = code;
        this.des = des;
    }

    public static EnumErrorCode get(Number code) {
        for (EnumErrorCode errorCode : EnumErrorCode.values()) {
    ...
    public static void main(String[] args) {
        EnumErrorCode errorCode = get(12001);
        if (null != errorCode)
