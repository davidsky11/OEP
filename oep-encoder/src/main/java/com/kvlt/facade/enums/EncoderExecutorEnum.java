...
public enum EncoderExecutorEnum {
	FFMPEGEXECUTOR("ffmpeg 转换执行器", "ffmpeg"),
    MENCODEREXECUTOR("mencoder 转换执行器", "mencoder"),
    YAMDIEXECUTOR("yamdi flv格式流媒体关键帧注入执行器", "yamdi"),
    QT_FASTSTART("qt-faststart mp4格式流媒体播放头部信息处理器", "qt-faststart");
