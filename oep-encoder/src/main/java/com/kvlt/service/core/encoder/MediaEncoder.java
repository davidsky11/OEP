 ...
 */
package com.kvlt.service.core.encoder;

import com.kvlt.facade.dto.EncoderObject;
import com.kvlt.facade.dto.MediaRecord;
import com.kvlt.facade.enums.EncoderExecutorEnum;
...
import com.kvlt.facade.exception.EncoderRuntimeException;
import com.kvlt.facade.exception.InputFormatException;
import com.kvlt.service.core.encoder.config.EncoderConfiguration;
import com.kvlt.service.core.encoder.executor.EncoderExecutor;
import com.kvlt.service.core.encoder.locator.EncoderLocator;
import com.kvlt.service.core.encoder.utils.DurationUtil;
import com.kvlt.utils.ContentTypeUtil;
import com.kvlt.utils.UuidUtil;
import com.kvlt.utils.io.FileUtil;
		...
		try {
			...
			*判断，而音质参数可以在原来的基础上提升一点，听起来要舒服很多，也不会太大，看情况调整。
			...
			if ("mp4".equalsIgnoreCase(format)) {
				...
				tempTargetFilePath.append(UuidUtil.get32UUID());
